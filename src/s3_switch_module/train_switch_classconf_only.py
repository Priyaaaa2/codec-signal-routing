"""
train_switch_classconf_only.py

Ablation: switch trained using ONLY predicted_class_fail_rate_loo and
car_confidence, no motion features at all. Tests whether the motion
features in the full switch contribute anything beyond these two signals.
"""
...
print("\n" + "=" * 62)
print("HELD-OUT EVAL (training-set split)")
print("=" * 62)
...
torch.save({'state_dict': model.state_dict(), 'scaler_mean': scaler.mean_,
           ...
           'switch_mlp_classconf_only.pth')
print("\nsaved switch_mlp_classconf_only.pth")
